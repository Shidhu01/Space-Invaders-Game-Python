...
pygame.display.set_caption("Space Shooter By WD69")
...
def main():
    ...
    while run:
        ...
        if (keys[pygame.K_d] or keys[pygame.K_RIGHT]) \
                and player.x + player_velocity + player.get_width() < WIDTH:  # Right
            player.x += player_velocity
        if (keys[pygame.K_w] or keys[pygame.K_UP]) and player.y - player_velocity > 0:  # Up
            player.y -= player_velocity
        if (keys[pygame.K_s] or keys[pygame.K_DOWN]) \
                and player.y + player_velocity + player.get_height() + 15 < HEIGHT:  # Down
            player.y += player_velocity
...
def main_menu():
    ...
    while run:
        WIN.blit(BG, (0, 0))
        title_label = title_font.render("Main Menu", True, (255, 255, 255))
        start_label = title_font.render("Start", True, (255, 255, 255))
        quit_label = title_font.render("Quit", True, (255, 255, 255))
